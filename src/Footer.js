        ...
        <div class="container-fluid  m-0 p-0 " >
            <div class="" style={{marginTop:'5rem'}}>
                <div class="row p-0 m-0">
                   ...
                   <a href="https://twitter.com/shridhar_kdev"> <i class="fab fa-twitter mx-3" style={{fontSize:'4rem',color:props.bg}}></i></a>
                   <a href="https://www.youtube.com/channel/UCv2hTdClW8560n89OZ6cazA?view_as=subscriber"> <i class="fab fa-youtube mx-3" style={{fontSize:'4rem',color:props.bg}}></i></a>
                   <a href="https://github.com/Shridhar-dev"> <i class="fab fa-github mx-3" style={{fontSize:'4rem',color:props.bg}}></i></a>
                   <a href="https://www.linkedin.com/in/shridhar-kamat-1015a41bb/" style={{textDecoration:'none'}}> <i class="fab fa-linkedin mx-3" style={{fontSize:'4rem',color:props.bg}}></i></a>
                    </div>
                    </div>
                </div>
